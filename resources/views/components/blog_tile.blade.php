...
<div class="blogTile{{ $num }}">
    <div
        class="flex flex-col items-stretch min-h-full pb-4 mb-6 transition-all duration-150 bg-white rounded-lg shadow-lg hover:shadow-2xl">
        <div class="md:flex-shrink-0">
            <img
                src="http://localhost:8000/blog/heftyb/imgs/FdTXnOmiFnZfPIHFOy7CHP0h8MNmi7TYFaDmqljt.jpg"
                alt="Blog Cover"
        ...
        <div class="flex flex-wrap items-center flex-1 px-4 py-1 text-center mx-auto border border-black">
            <a href="#" class="hover:underline">
                <h2 class="text-6xl font-bold tracking-normal text-gray-800">
                    How you can change you life by not sucking: The legend of the man who conquered the world only to set it free
                </h2>
            </a>
        </div>
        <hr class="border-gray-300"/>
